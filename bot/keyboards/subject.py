...
first_biology = [
    [InlineKeyboardButton(text="Kimyo", callback_data="sub_s_first_Kimyo"),
...
k_first_physics = InlineKeyboardMarkup(inline_keyboard=first_physics)
...
k_first_chemistry = InlineKeyboardMarkup(inline_keyboard=first_chemistry)
...
first_history = [
    ...
    [InlineKeyboardButton(text="Fransuz tili", callback_data="sub_s_first_Fransuz_tili"),
     InlineKeyboardButton(text="Nemis tili", callback_data="sub_s_first_Nemis_tili")],
[InlineKeyboardButton(text="Geografiya", callback_data="sub_s_first_Geografiya")],
    [InlineKeyboardButton(text="Ona tili va adabiyoti", callback_data="sub_s_first_Ona_tili_va_adabiyoti")],
    [InlineKeyboardButton(text="Rus tili va adabiyoti", callback_data="sub_s_first_Rus_tili_va_adabiyoti")],
    [InlineKeyboardButton(text="Qoraqalpoq tili va adabiyoti", callback_data="sub_s_first_Qoraqalpoq_tili_va_adabiyoti")],
[InlineKeyboardButton(text="Ortga qaytish🔙", callback_data="select_back")]
...
first_math = [
    [InlineKeyboardButton(text="Fizika", callback_data="sub_s_first_Fizika"),
     InlineKeyboardButton(text="Ingliz tili", callback_data="sub_s_first_Ingliz_tili")],
    [InlineKeyboardButton(text="Fransuz tili", callback_data="sub_s_first_Fransuz_tili"),
     InlineKeyboardButton(text="Nemis tili", callback_data="sub_s_first_Nemis_tili")],
    [InlineKeyboardButton(text="Kimyo", callback_data="sub_s_first_Kimyo"),
...
second_biology = [
    [InlineKeyboardButton(text="Kimyo", callback_data="sub_s_second_Kimyo"),
...
second_english = [
[InlineKeyboardButton(text="Fizika", callback_data="sub_s_second_Fizika"),
InlineKeyboardButton(text="Kimyo", callback_data="sub_s_second_Kimyo")],
...
k_second_english = InlineKeyboardMarkup(inline_keyboard=second_english)
...
k_second_french = InlineKeyboardMarkup(inline_keyboard=second_french)
...
k_second_deutsch = InlineKeyboardMarkup(inline_keyboard=second_deutsch)



second_history = [
[InlineKeyboardButton(text="Geografiya", callback_data="sub_s_second_Geografiya"),
...
k_second_history = InlineKeyboardMarkup(inline_keyboard=second_history)
...
k_second_geography = InlineKeyboardMarkup(inline_keyboard=second_geography)
...
k_second_math = InlineKeyboardMarkup(inline_keyboard=second_math)

second_mother_t = [
[InlineKeyboardButton(text="Biologiya", callback_data="sub_s_second_Biologiya"),
InlineKeyboardButton(text="Tarix", callback_data="sub_s_second_Tarix")],
[InlineKeyboardButton(text="Ingliz tili", callback_data="sub_s_second_Ingliz_tili"),
InlineKeyboardButton(text="Fransuz tili", callback_data="sub_s_second_Fransuz_tili")],
...
k_second_mother_t = InlineKeyboardMarkup(inline_keyboard=second_mother_t)
